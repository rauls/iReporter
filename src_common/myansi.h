...
#include "FWA.h"	// for DEF_MAC, DEF_WINDOWS etc
...
#define	UNXPATHSEP			'/'
...
#if	DEF_MAC
	#define	PATHSEP				MACPATHSEP
	#define	OTHER_OS1_PATHSEP	UNXPATHSEP
	#define	OTHER_OS2_PATHSEP	WINPATHSEP
	#define	PATHSEPSTR			":"
	#define	PATHBACKDIR			":" // Apparently no way of going back a directory on Macs, need "exact" path
	...
	#define	PATHBACKDIR			"\\..\\" 
#else
	#define	PATHSEP				UNXPATHSEP
	#define	OTHER_OS1_PATHSEP	WINPATHSEP
	#define	OTHER_OS2_PATHSEP	MACPATHSEP
	#define	PATHSEPSTR			"/"
	#define	PATHBACKDIR			"/../" 
#endif
